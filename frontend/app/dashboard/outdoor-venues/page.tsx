...
export default function OutdoorVenuesDashboard() {
  const router = useRouter();
  const [user, setUser] = useState<VendorUser | null>(null);
  const [activeCategory] = useState<VenueCategory>('outdoor-venues');
  ...
  const [appointments] = useState<Appointment[]>([
    {
      id: '1',
      customerName: 'Emma & Lucas',
      email: 'emma@email.com',
      phone: '+94 77 456 7890',
      requestedDate: 'Jan 18, 2026',
      requestedTime: '3:00 PM',
      weddingDate: 'March 5, 2026',
      packageInterest: 'Garden Wedding Package - Outdoor Venue',
      expectedGuests: '150-200 people',
      message: 'We love outdoor settings and want a beautiful garden wedding. Please let us know about customization options.',
      status: 'new',
    ...
    },
    {
      ...
      packageInterest: 'Beach Wedding Venue',
      expectedGuests: '80-100 people',
      message: 'Looking for a beautiful outdoor venue for an intimate beach wedding.',
      status: 'accepted',
      venueName: 'Cinderella Hotel'
    }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm" style={{color: '#755A7B'}}>Outdoor Venues</p>
            </div>
          </div>
          <button
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Garden Wedding Venue - Up to 200 Guests"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                    rows={3}
                    placeholder="e.g., Garden Setup, Gazebo, Outdoor Lighting, Parking, Washrooms"
                  />
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-lg font-medium text-gray-800">Garden Wedding Venue</p>
                    </div>
                    
                    <div>
                      <label className="block text-sm font-semibold text-gray-600 mb-2">Price Per Day (Rs.)</label>
                      <div className="flex items-baseline">
                        <span className="text-3xl font-bold" style={{color: '#755A7B'}}>Rs. 80,000</span>
                        <span className="text-lg text-gray-400 line-through ml-2">Rs. 100,000</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['Garden Setup', 'Gazebo', 'Lighting', 'Parking', 'Washrooms'].map((facility) => (
                          <span
                            key={facility}
                    ...
                    <p className="text-sm text-gray-500 italic">
                      This package is perfect for couples who want a beautiful outdoor wedding in a natural setting.
                    </p>
