...
export default function PlaceBookingPage() {
  ...
  const getCategoryBannerText = () => {
    switch(activeCategory) {
      case 'live-bands':
        return 'Live Bands Bookings';
      case 'djs':
        return 'DJ Services Bookings';
      case 'traditional-performers':
        return 'Traditional Performers Bookings';
      default:
  ...
  useEffect(() => {
    ...
    const savedBookings = localStorage.getItem('entertainmentBookings');
    if (savedBookings) {
