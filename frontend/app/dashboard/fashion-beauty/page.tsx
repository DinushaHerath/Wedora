...
export default function FashionBeautyDashboard() {
  ...
  useEffect(() => {
    ...
    const savedPackages = localStorage.getItem('fashionBeautyPackages');
    if (savedPackages) {
  ...
  const handleSubmitPackage = (e?: React.FormEvent) => {
    ...
    localStorage.setItem('fashionBeautyPackages', JSON.stringify(updatedPackages));
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Complete Bridal Makeup & Hair"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  placeholder="e.g., Makeup, Hair, Draping"
                  style={{borderColor: '#e5e7eb'}}
                />
              </div>
