...
export default function TransportationDashboard() {
  ...
  const getCategoryBannerText = () => {
    switch(activeCategory) {
      case 'wedding-cars':
        return 'Manage Wedding Cars';
      case 'luxury-vehicles':
        return 'Manage Luxury Vehicles';
      case 'guest-transport':
        return 'Manage Guest Transport';
      default:
        return 'Transportation Package Manager';
    }
  };
      ...
      <aside className="w-full md:w-64 bg-white shadow-lg flex flex-col">
        ...
        <nav className="flex-1 p-4">
          <div className="mb-6">
            ...
            <button 
              onClick={() => router.push('/dashboard/transportation/posted-packages')}
              className="w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-1 transition-colors text-gray-600 hover:bg-gray-100"
            >
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8">
          ...
          >
            ...
            <p className="text-sm md:text-xl text-white" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.7)'}}>Create and manage your transportation packages</p>
          </div>
