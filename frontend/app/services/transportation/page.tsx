  ...
  const mockVendors: Vendor[] = [
    {
      ...
      image: '/ven1.png',
      packageCount: 6,
      features: ['Chauffeur Service', 'Decorated Car', 'Premium Vehicles', 'Flexible Timing']
    },
    {
      id: '2',
      name: 'Elite Transport Services',
      organizationName: 'Elite Transport Services',
      category: ['guest-transport', 'luxury-vehicles'],
      ...
      image: '/ven2.png',
      packageCount: 5,
      features: ['Group Transport', 'Air Conditioning', 'Professional Drivers', 'GPS Tracking']
    },
    {
      id: '3',
      name: 'Luxury Rides Wedding',
      organizationName: 'Luxury Rides Wedding',
      ...
      image: '/ven3.png',
      packageCount: 4,
      features: ['Chauffeur Service', 'Decorated Car', 'Luxury Fleet', 'Wedding Packages']
    },
    {
      id: '4',
      name: 'Premier Wedding Transport',
      organizationName: 'Premier Wedding Transport',
      category: ['guest-transport', 'bridal-cars'],
      ...
      image: '/ven1.png',
      packageCount: 7,
      features: ['Group Transport', 'Chauffeur Service', 'Flexible Timing', 'Professional Drivers']
    }
  ];

  const [vendors, setVendors] = useState<Vendor[]>(mockVendors);

  const features = ['Chauffeur Service', 'Decorated Car', 'Group Transport', 'Air Conditioning', 'Professional Drivers', 'GPS Tracking', 'Luxury Fleet', 'Flexible Timing'];
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search by transport service or location..."
                value={searchQuery}
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'bridal-cars'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'bridal-cars' ? {backgroundColor: '#755A7B'} : {}}
            >
              Bridal Cars
            </button>
            <button
              ...
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'guest-transport'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'guest-transport' ? {backgroundColor: '#755A7B'} : {}}
            >
              Guest Transport
            </button>
            <button
              ...
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'luxury-vehicles'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'luxury-vehicles' ? {backgroundColor: '#755A7B'} : {}}
            >
              Luxury Vehicles
            </button>
          </div>
            ...
            <div key={vendor.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  ...
                  <Link
                    href={`/services/transportation/${vendor.id}`}
