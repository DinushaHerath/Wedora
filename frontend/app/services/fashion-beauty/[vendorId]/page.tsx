...
export default function BeautyVendorDetailPage() {
  ...
  const mockVendor: Vendor = {
    ...
    reviewCount: 178,
    image: '/ven1.png',
    about: 'Glamour Bridal Studio is the premier destination for bridal makeup and hair styling in Sri Lanka. Our team of certified beauty professionals brings over 12 years of experience in creating stunning bridal looks. We specialize in both traditional and contemporary styles using premium international beauty products.',
  ...
  const mockPackages: Package[] = [
    {
      ...
      title: 'Premium Bridal Makeup Package',
      price: 68000,
      services: ['Bridal Makeup', 'Airbrush Makeup', 'Touch-up Service', 'False Lashes'],
      photos: ['/pack1.png'],
      stock: 6,
      discount: '15%',
      discountType: 'Early Bird',
      description: 'Complete bridal makeup with airbrush technique, touch-up service throughout the day, and premium products.',
      duration: '4-5 hours'
    },
    {
      id: '2',
      ...
      price: 38000,
      services: ['Bridal Makeup', 'False Lashes', 'Touch-up Kit'],
      photos: ['/pack2.png'],
      stock: 10,
      description: 'Traditional bridal makeup with long-lasting products and complimentary touch-up kit.',
      duration: '3-4 hours'
    },
    {
      id: '3',
      ...
      title: 'Bridal Hair Styling Premium',
      price: 42000,
      services: ['Hair Styling', 'Hair Extensions', 'Hair Accessories', 'Pre-Wedding Trial'],
      photos: ['/pack3.png'],
      stock: 8,
      discount: '10%',
      discountType: 'Weekend Special',
      description: 'Professional bridal hairstyling with extensions, accessories, and pre-wedding trial session.',
      duration: '3-4 hours'
    },
    {
      id: '4',
      ...
      price: 25000,
      services: ['Hair Styling', 'Hair Accessories'],
      photos: ['/pack4.png'],
      stock: 12,
      description: 'Beautiful hairstyling perfect for your special day with elegant accessories.',
      duration: '2-3 hours'
    },
    {
      id: '5',
      ...
      title: 'Complete Saree Draping Package',
      price: 18000,
      services: ['Saree Draping', 'Pleating', 'Pin Setting'],
      photos: ['/pack1.png'],
      stock: 15,
      description: 'Expert saree draping service with perfect pleating and secure pin setting.',
    ...
    },
    {
      ...
      vendorId: vendorId,
      category: 'traditional-dressing',
      title: 'Premium Traditional Dressing',
      price: 35000,
      services: ['Saree Draping', 'Traditional Jewelry Setting', 'Accessories Arrangement'],
      photos: ['/pack2.png'],
      stock: 8,
      discount: '8%',
      discountType: 'Limited Offer',
      description: 'Complete traditional dressing with saree draping, jewelry setting, and accessory arrangement.',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        >
          <FaArrowLeft /> Back to Beauty Services
        </button>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex gap-2 overflow-x-auto pb-2">
          ...
          {vendor.category.includes('bridal-makeup') && (
            <button
              onClick={() => setSelectedCategory('bridal-makeup')}
              className="px-6 py-2 rounded-full font-medium whitespace-nowrap transition-all"
              style={{
                backgroundColor: selectedCategory === 'bridal-makeup' ? '#755A7B' : '#f3f4f6',
                color: selectedCategory === 'bridal-makeup' ? 'white' : '#6b7280'
              }}
            >
              Bridal Makeup
            </button>
          )}
          {vendor.category.includes('hair-styling') && (
            <button
              onClick={() => setSelectedCategory('hair-styling')}
              className="px-6 py-2 rounded-full font-medium whitespace-nowrap transition-all"
              style={{
                backgroundColor: selectedCategory === 'hair-styling' ? '#755A7B' : '#f3f4f6',
                color: selectedCategory === 'hair-styling' ? 'white' : '#6b7280'
              }}
            >
              Hair Styling
            </button>
          )}
          {vendor.category.includes('traditional-dressing') && (
            <button
              onClick={() => setSelectedCategory('traditional-dressing')}
              className="px-6 py-2 rounded-full font-medium whitespace-nowrap transition-all"
              style={{
                backgroundColor: selectedCategory === 'traditional-dressing' ? '#755A7B' : '#f3f4f6',
                color: selectedCategory === 'traditional-dressing' ? 'white' : '#6b7280'
              }}
            >
