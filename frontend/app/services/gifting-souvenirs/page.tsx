...
type GiftCategory = 'wedding-favors' | 'gift-boxes' | 'personalized-items' | 'return-gifts';
...
export default function GiftingSouvenirsServices() {
  ...
  const mockVendors: Vendor[] = [
    {
      ...
      category: ['wedding-favors', 'personalized-items'],
      ...
      image: '/ven1.png',
      packageCount: 6,
      features: ['Custom Packaging', 'Personalized Gifts', 'Bulk Orders', 'Gift Wrapping', 'Delivery Service']
    },
    {
      id: '2',
      name: 'Premium Gift Boxes',
      organizationName: 'Premium Gift Boxes',
      category: ['gift-boxes', 'return-gifts'],
      ...
      image: '/ven2.png',
      packageCount: 5,
      features: ['Luxury Packaging', 'Theme Customization', 'Bulk Orders', 'Express Delivery']
    },
    {
      id: '3',
      name: 'Personalized Treasures',
      organizationName: 'Personalized Treasures',
      category: ['personalized-items', 'wedding-favors'],
      ...
      image: '/ven3.png',
      packageCount: 7,
      features: ['Personalized Gifts', 'Custom Engraving', 'Photo Printing', 'Gift Wrapping', 'Theme Customization']
    },
    {
      id: '4',
      name: 'Wedding Souvenirs Paradise',
      organizationName: 'Wedding Souvenirs Paradise',
      category: ['wedding-favors', 'return-gifts', 'gift-boxes'],
      ...
      image: '/ven1.png',
      packageCount: 8,
      features: ['Custom Packaging', 'Bulk Orders', 'Gift Wrapping', 'Delivery Service', 'Theme Customization']
    }
  ];

  const [vendors, setVendors] = useState<Vendor[]>(mockVendors);

  const features = ['Custom Packaging', 'Personalized Gifts', 'Bulk Orders', 'Gift Wrapping', 'Delivery Service', 'Express Delivery', 'Theme Customization', 'Custom Engraving', 'Photo Printing', 'Luxury Packaging'];
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-opacity-50 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-lg">Find the perfect gifts and souvenirs for your special day</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search by gift provider or location..."
                value={searchQuery}
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            <button
              onClick={() => setSelectedCategory('wedding-favors')}
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'wedding-favors'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'wedding-favors' ? {backgroundColor: '#755A7B'} : {}}
            >
              Wedding Favors
            </button>
            <button
              ...
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'gift-boxes'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'gift-boxes' ? {backgroundColor: '#755A7B'} : {}}
            >
              Gift Boxes
            </button>
            <button
              onClick={() => setSelectedCategory('personalized-items')}
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'personalized-items'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'personalized-items' ? {backgroundColor: '#755A7B'} : {}}
            >
              Personalized Items
            </button>
            <button
              onClick={() => setSelectedCategory('return-gifts')}
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'return-gifts'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'return-gifts' ? {backgroundColor: '#755A7B'} : {}}
            >
              Return Gifts
            </button>
          </div>
            ...
            <div key={vendor.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  ...
                  <Link
                    href={`/services/gifting-souvenirs/${vendor.id}`}
