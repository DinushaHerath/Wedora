...
type EntertainmentCategory = 'bands' | 'djs' | 'live-music' | 'dancers' | 'performers';
...
export default function EntertainmentServices() {
  const router = useRouter();
  const [selectedCategory, setSelectedCategory] = useState<EntertainmentCategory | 'all'>('all');
  ...
  const mockVendors: Vendor[] = [
    {
      ...
      image: '/ven1.png',
      packageCount: 6,
      features: ['Professional Sound System', 'Stage Lighting', 'MC Services', 'Backup Equipment', 'Rehearsal Included', 'Song Requests']
    },
    {
      id: '2',
      name: 'Elite DJ Entertainment',
      organizationName: 'Elite DJ Entertainment',
      category: ['djs'],
      ...
      image: '/ven2.png',
      packageCount: 5,
      features: ['Premium Sound System', 'LED Dance Floor', 'Lighting Effects', 'Music Library', 'MC Services', 'Karaoke Setup']
    },
    {
      id: '3',
      name: 'Traditional Dance Ensemble',
      organizationName: 'Traditional Dance Ensemble',
      category: ['dancers', 'performers'],
      ...
      image: '/ven3.png',
      packageCount: 4,
      features: ['Kandyan Dancing', 'Costume Included', 'Choreography', 'Professional Performers', 'Sound System', 'Cultural Shows']
    },
    {
      id: '4',
      name: 'Melodious Wedding Musicians',
      organizationName: 'Melodious Wedding Musicians',
      ...
      image: '/ven1.png',
      packageCount: 7,
      features: ['Live Band Performance', 'String Quartet', 'Acoustic Sets', 'Professional Sound System', 'Song Requests', 'Rehearsal Included']
    }
  ];

  const [vendors, setVendors] = useState<Vendor[]>(mockVendors);

  const features = ['Professional Sound System', 'Stage Lighting', 'MC Services', 'Backup Equipment', 'Rehearsal Included', 'Song Requests', 'LED Dance Floor', 'Lighting Effects', 'Music Library', 'Karaoke Setup', 'Choreography', 'Cultural Shows'];
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-opacity-50 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-lg">Find the perfect entertainment for your special day</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search by entertainer or location..."
                value={searchQuery}
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            <button
              onClick={() => setSelectedCategory('bands')}
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'bands'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'bands' ? {backgroundColor: '#755A7B'} : {}}
            >
              Bands
            </button>
            <button
              onClick={() => setSelectedCategory('djs')}
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'djs'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'djs' ? {backgroundColor: '#755A7B'} : {}}
            >
              DJs
            </button>
            <button
              onClick={() => setSelectedCategory('live-music')}
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'live-music'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'live-music' ? {backgroundColor: '#755A7B'} : {}}
            >
              Live Music
            </button>
            <button
              onClick={() => setSelectedCategory('dancers')}
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'dancers'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'dancers' ? {backgroundColor: '#755A7B'} : {}}
            >
              Dancers
            </button>
            <button
              onClick={() => setSelectedCategory('performers')}
              className={`px-6 py-2 rounded-full font-medium transition-colors ${
                selectedCategory === 'performers'
                  ? 'text-white'
                  : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
              style={selectedCategory === 'performers' ? {backgroundColor: '#755A7B'} : {}}
            >
              Performers
            </button>
          </div>
            ...
            <div key={vendor.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  ...
                  <Link
                    href={`/services/entertainment/${vendor.id}`}
